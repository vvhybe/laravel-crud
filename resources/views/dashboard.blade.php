...
@endsection
@section('content')
<div class="w-[60%] flex justify-between my-5">
    <h1 class="text-3xl font-bold">Products Dashboared:</h1>
    <a href="/create" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-3 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Product</a>
</div>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            @foreach ($products as $product)
                @include('dashboardproduct', ['product' => $product])
            @endforeach
        </tbody>
