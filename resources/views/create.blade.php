...
<section class="h-screen w-screen flex items-center justify-center">
        <div class="w-[440px] px-8 py-6 flex items-center justify-center gap-4 flex-col bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition-all">
                <h1 class="text-3xl font-bold text-blue-700">Add Product</h1>
                <form class="w-full" action="/store" method="POST">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                          ...
                          <input type="number" name="quantity" id="qte" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="1" placeholder="1" required>
                        </div>
